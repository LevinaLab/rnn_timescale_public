...
#SBATCH --array=0-2                     # maps 1 to N to SLURM_ARRAY_TASK_ID below
...
python "./training/parallel_dispatcher.py" --test --path_to_script="training/train_growth.py" --params_file="prod"
